...
public class Kth2Test {
    ...
    public void test01_checkQuickSort() throws IOException {
        int pos = rnd.nextInt(array.length);
        int check = K_statisticsOptimised.kthSmallest(array, 0, array.length - 1, pos + 1);
        Arrays.sort(array);
        Assert.assertTrue(check == array[pos]);
    }
}
